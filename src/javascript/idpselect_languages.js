...
function IdPSelectLanguages(){
    ...
    'de': {
        ...
        'fatal.noReturnURL' : "URL return Parameter fehlt",
        'fatal.badProtocol' : "return-Request muss mit https:// oder http:// beginnen",
        'idpPreferred.label': 'Nutzen Sie eine bevorzugte Institution:',
        'idpEntry.label': 'Oder geben Sie den Namen (oder Teile davon) Ihrer Institution an:',
        ...
        'idpList.showSearch' : 'Institution selbst eingeben',
        'submitButton.label': 'OK',
        'helpText': 'Hilfe',
        'defaultLogoAlt' : 'Standardlogo',
        'autoFollow.message' : 'Diese Auswahl automatisch benutzen',
        'autoFollow.never' : 'Nie',
        'autoFollow.time0' : 'Einen Tag',
        'autoFollow.time1' : '3 Monate',
        'autoFollow.time2' : '9 Monate'
        },
    'ja': {
